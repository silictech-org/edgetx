...
// #define ADC_CHANNEL_STICK_LH          LL_ADC_CHANNEL_16   // ADC1_IN16
// #define ADC_CHANNEL_STICK_LV          LL_ADC_CHANNEL_17   // ADC1_IN17
// #define ADC_CHANNEL_STICK_RH          LL_ADC_CHANNEL_14   // ADC1_IN14
// #define ADC_CHANNEL_STICK_RV          LL_ADC_CHANNEL_15   // ADC1_IN15
...
//   #define SPORT_UPDATE_PWR_GPIO         GPIO_PIN(GPIOJ, 7) // PH.13
// #endif
...
// #else
//   #define PCBREV_GPIO                   GPIO_PIN(GPIOB, 11) // PI.11
//   #define PCBREV_VALUE()                (gpio_read(PCBREV_GPIO) >> 12)
// #endif
...
// Telemetry
// #define TELEMETRY_DIR_GPIO              GPIO_PIN(GPIOA, 6) // PA.06 // todo soft handover
#define TELEMETRY_HALF_UART
...
#define BACKLIGHT_GPIO                  GPIO_PIN(GPIOG, 12) // PG.12
...
#define INTMODULE_TX_GPIO               GPIO_PIN(GPIOB, 13) // PB.11
#define INTMODULE_RX_GPIO               GPIO_PIN(GPIOB, 13) // PB.10
