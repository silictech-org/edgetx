...
static void lcdSpiConfig(void)
{
  ...
  stm32_gpio_enable_clock(LCD_DC_GPIO);
  ...
  LL_GPIO_Init(LCD_DC_GPIO, &GPIO_InitStructure);
...
void LCD_Init_LTDC()
{
  ...
  clkConfig.PLL3.PLL3M = 24;
  clkConfig.PLL3.PLL3N = 300;
  clkConfig.PLL3.PLL3P = 2;
  clkConfig.PLL3.PLL3Q = 2;
  clkConfig.PLL3.PLL3R = 30;
  clkConfig.PLL3.PLL3RGE = RCC_PLL3VCIRANGE_0;
  clkConfig.PLL3.PLL3VCOSEL = RCC_PLL3VCOWIDE;
  clkConfig.PLL3.PLL3FRACN = 0;
